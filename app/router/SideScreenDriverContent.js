...
export default function SideScreenProviderContent({ navigation, props }) {
    ...
    return (
        <View style={{flex: 1, backgroundColor: 'rgba(95, 135, 189,1)'}}>
            <DrawerContentScrollView {...props}>
                ...
                <Drawer.Section style={styles.item}>
                    <DrawerItem
                        ...
                        label="Change to Provider"
                        onPress={() => Alert.alert(
                            "Change Interface",
                            "You are about to change to the provider interface.",
                        [
                          {
                            text: "Cancel",
                            style: "cancel"
                ...
                <Drawer.Section style={styles.drawerSection}>
                    ...
                    label="Check Charging Time"
                    onPress={() => {navigation.navigate('Check Charging Time')}}
                    />
                    <DrawerItem  style={styles.item}
                    icon = {({color,size}) => (
                        <Icon 
